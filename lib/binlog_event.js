...
BinlogEvent.prototype.replicate = function() {
}
...
function TableMap(parser, options, neorep) {
  BinlogEvent.apply(this, arguments);
  this.tableMap = options.tableMap;
  this.neo4jDb = neorep.neo4jDb;
  ...
  if(neorep._skipSchema(this.schemaName, this.tableName)){
...
TableMap.prototype.replicate = function() {
  BinlogEvent.prototype.replicate.apply(this);
};
