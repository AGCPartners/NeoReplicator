...
function NeoReplicator(settings, options) {
  ...
  var ctrlDsn = cloneObjectSimple(settings.mysql);
  ctrlDsn.database = 'information_schema';
  this.dsn = settings.mysql;
...
NeoReplicator.prototype._handleDisconnect = function() {
  var self = this;
...
NeoReplicator.prototype._handleConnectionDisconnect = function(){
  var self = this;
...
NeoReplicator.prototype.disconnect = function(){
  var self = this;
  // Binary log connection does not end with destroy()
  self.connection.destroy();
  self.ctrlConnection.query(
...
NeoReplicator.prototype.reconnect = function(){
  var self =  this;
